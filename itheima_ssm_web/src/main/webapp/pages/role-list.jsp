	...
	<div class="wrapper">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="删除" onclick="delRole()">
									...
									<c:forEach items="${pageInfo.list}" var="role">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/role/edit?id=${role.id}" class="btn bg-olive btn-xs">编辑</a>
		...
		<script>
			...
			function delRole(){
				...
				getChosen(ids);
				alert(ids);
                location.href='${pageContext.request.contextPath}/role/delRole?ids='+ids;
			}
